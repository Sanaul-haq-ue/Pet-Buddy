...
@section('adminContent')
    ...
    <form id="editProductForm" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="_product_slug" value="{{ $product->slug }}">
            ...
            <div class="row g-5">
                ...
                <div class="col-12 col-lg-8">
                    <div class="d-flex flex-column gap-5">
                        ...
                        <section class="glass-card">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <input class="input-underline" name="product_name" value="{{ $product->product_name }}" placeholder="e.g. Organic Hemp Calming Chews"
                                        type="text" required />
                                </div>
                                <div class="col-md-4">
                                            ...
                                            <select name="sub_category_id" id="subCategorySelect" class="form-control"
                                                ...
                                                @foreach ($subCategories as $subCategory)
                                                    <option value="{{ $subCategory->id }}"
                                                        ...
                                                        {{ $product->category_id == $subCategory->productCategory_id ? '' : 'hidden' }}
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="input-underline sm" name="description" placeholder="Describe the benefits, ingredients, and usage instructions..."
                                        rows="4" style="resize: none;">{{ $product->description }}</textarea>
                                </div>
                            </div>
                        </section>

                        <!-- Add Additional Information Button Section -->
                        <section class="glass-card {{ $product->details->isNotEmpty() ? 'd-none' : '' }}" id="addInfoSection">
                        ...
                        <section class="glass-card {{ $product->details->isNotEmpty() ? '' : 'd-none' }}" id="detailsSection">
                            ...
                            <div class="row g-4" id="detailsContainer">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row g-4">
                                                    <div class="col-5">
                                                        ...
                                                        <input type="text" name="detail_title[]" value="{{ $detail->title }}" class="input-underline" placeholder="Title">
                                                    </div>
                                                    <div class="col-5">
                                                        <input type="text" name="detail_description[]" value="{{ $detail->description }}" class="input-underline" placeholder="Description">
                                                    </div>
                                                    <div class="col-2">
                                                    </div>
                                                </div>
                                ...
                                @else
                                    <div class="col-lg-12">
                                        <div class="row g-4">
                                            <div class="col-5">
                                                <input type="text" name="detail_title[]" class="input-underline" placeholder="Title">
                                            </div>
                                            <div class="col-5">
                                                <input type="text" name="detail_description[]" class="input-underline" placeholder="Description">
                                            </div>
                                            <div class="col-2">
                                            </div>
                                        </div>
                        ...
                        <section class="glass-card">
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-4">
                                            ...
                                            <div class="position-relative">
                                                <input class="input-underline bold" name="regular_price" value="{{ $product->regular_price }}" placeholder="0.00" type="number"
                                                    min="0" style="padding-left: 16px;" />
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            ...
                                            <div class="position-relative">
                                                <input class="input-underline bold" name="selling_price" value="{{ $product->selling_price }}" placeholder="0.00"
                                                    type="number" min="0"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="position-relative">
                                                <input class="input-underline bold" name="buying_price" value="{{ $product->buying_price }}"
                                ...
                                <div class="col-6 col-lg-3">
                                    ...
                                    <input class="input-underline sm" name="unit" value="{{ $product->unit }}" placeholder="e.g. 250g bag"
                                        type="text" required />
                                </div>
                                <div class="col-6 col-lg-3">
                                    <label class="label-text">QUANTITY <span class="text-danger">*</span></label>
                                    <input class="input-underline sm" name="quantity" value="{{ $product->quantity }}" placeholder="50" type="number" min="0"
                                        required />
                                </div>
                                <div class="col-12">
                                    <label class="label-text">SKU ID</label>
                                    <input class="input-underline mono" name="sku_id" value="{{ $product->sku_id }}" placeholder="AM-WC-001" type="text" />
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <div class="d-flex flex-column gap-5">
                        ...
                        <section class="glass-card" style="padding: 2rem;">
                            ...
                            <div class="upload-area" id="uploadArea">
                                <img id="previewImage"
                                    src="{{ $product->image ? asset($product->image) : 'https://lh3.googleusercontent.com/aida-public/AB6AXuDfaKwcxLSdf4Kuzp5sN9lwLYcHAcavBBu3DPPR4sg-c9lwGe7hkRUk1vOzq7Wzun3JDAtr1Ue90UpFucuxN1V6AI-wqycGMdWO96-8oqGShFc_HcBUV9UHcibybnEs66SzjDTmpBLEU1UdX0OgDHvLyAUFQcbrfiihok-YpXI8220N-z0O4uIppOecQDJmFq7k9-g0-BDJVlie2OKE2Ln6rb0aplBZJ10u1Pfv3VtgUz99CAX2yFF12vbq-rjB-nCUfbVemHD17-h3' }}"
                                    alt="Preview">
        ...
        <div class="footer-bar">
            <div class="d-flex align-items-center justify-content-center w-100">
                ...
                <button type="submit" class="btn-save signature-glow" id="saveProductBtn">Save Product</button>
            </div>
        </div>
    ...
    <script>
        ...
        let selected = [];
        @if (!empty($product->species_ids))
            @foreach ($product->species_ids as $id)
                @php
                    $matchedSpecie = $species->firstWhere('id', $id);
                @endphp
                @if ($matchedSpecie)
                    selected.push({
                        id: "{{ $matchedSpecie->id }}",
                        name: "{{ $matchedSpecie->species_name }}"
                    });
                @endif
            @endforeach
            render();
    ...
    <script>
        ...
        let isOn = {{ $product->is_visible ? 'true' : 'false' }};
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        if (xhr.status === 422) {
                            ...
                            const response = xhr.responseJSON;
                            toastr.error((response && response.message) ? response.message : 'Something went wrong.');
                        }
                    },
                    complete: function () {
