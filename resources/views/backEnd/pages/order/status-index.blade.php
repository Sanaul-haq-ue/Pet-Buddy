...
@section('adminContent')
    ...
    <script>
        ...
        // function openStatusDrawer(btn) {
        //     _activeStatusBtn = btn;
        //     const currentStatus = btn.dataset.currentStatus;
        //     const orderId = btn.dataset.orderId;

        //     // Set drawer header
        //     document.getElementById('statusDrawerOrderId').textContent = '#' + orderId;
        ...
        //     dot.style.background = statusDotColors[currentStatus] || '#888';
        ...
        //             _selectedStatusClass = card.dataset.class;
        //         }
        //     });
        // }
        ...
        //         document.querySelectorAll('.status-option-card').forEach(c => c.classList.remove(
        //             'selected'));
        //         this.classList.add('selected');
        //         this.querySelector('input[type=radio]').checked = true;
        //         _selectedStatusClass = this.dataset.class;
        //     });
        // });

        // function applyStatusChange() {
        //     if (!_activeStatusBtn) return;

        //     const selectedCard = document.querySelector('.status-option-card.selected');
        //     if (!selectedCard) return;

        //     const newStatus = selectedCard.dataset.status;
        //     const newClass = selectedCard.dataset.class;

        //     // Update the trigger button
        //     const allStatusClasses = ['status-pending', 'status-confirmed', 'status-processing', 'status-outfordelivery',
        //         'status-delivered'
        //     ];
        //     _activeStatusBtn.classList.remove(...allStatusClasses);
        //     _activeStatusBtn.classList.add(newClass);
        //     _activeStatusBtn.dataset.currentStatus = newStatus;

        //     // Update button text (keep the icon)
        //     const icon = _activeStatusBtn.querySelector('.material-symbols-outlined');
        //     _activeStatusBtn.innerHTML = '';
        //     if (icon) _activeStatusBtn.appendChild(icon);
        //     _activeStatusBtn.appendChild(document.createTextNode(' ' + newStatus));

        //     // Close the offcanvas
        //     const offcanvasEl = document.getElementById('statusDrawer');
